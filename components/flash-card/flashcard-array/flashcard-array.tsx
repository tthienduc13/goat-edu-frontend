...
import FlashcardArrayProps from "../interface/IFlashcardArray";
import Flashcard from "../flashcard/flashcard";
import "./flashcard-array.scss";
...
function FlashcardArray({
  ...
  }, [cardNumber, cycle, numberOfCards, cards, onCardChange]);
  ...
  const prevCard = useCallback(() => {
    ...
    onCardChange(cards[currentCardNumber].id, currentCardNumber + 1);
  }, [cardNumber, cycle, cards, onCardChange]);
  ...
  }, [forwardRef, nextCard, prevCard, resetArray, cards, onCardChange]);
