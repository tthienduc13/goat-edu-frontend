...
export const DiscussionCard = () => {
  return (
    <Link href="/post">
      <div className="w-80 ">
        <FollowerPointerCard
          title={<TitleComponent title="Thien Duc" avatar="" />}
        >
          <div
            className={cn(
          ...
          >
            ...
            <div className=" p-4">
              ...
              <h2 className="font-normal my-4 text-sm text-zinc-500">
                Grids are cool, but Tailwindcss grids are cooler. In this
                article, we will learn how to create amazing Grid layouts with
                Tailwindcs grid and React.
              </h2>
