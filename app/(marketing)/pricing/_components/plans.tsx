        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          ...
          {bannerText ? (
            <div className="w-full lg:w-auto flex justify-center my-4">
              <p className="w-full px-4 py-3 text-xs bg-violet-100 text-black dark:bg-violet-300/30 dark:text-white/80 rounded-xl">
                {bannerText}
              </p>
            </div>
          ) : null}
                  ...
                  <Label
                    className={cn(
                      frequency.value === option.value
                        ? "bg-violet-500/90 text-white dark:bg-violet-900/70 dark:text-white/70"
                        : "bg-transparent text-gray-500 hover:bg-violet-500/10",
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      !tier.highlighted && !tier.featured
                        ...
                        : "bg-violet-300 hover:bg-violet-400 dark:bg-violet-600 dark:hover:bg-violet-700",
